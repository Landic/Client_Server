...
void Socket::SendDataMessage()
{
	...
	cin.ignore();
	cout << "Enter count smartphones -> ";
	cin.get(message, MAXSTRLEN);
	SendData(message);
	cin.ignore();
	cout << "Enter count laptop -> ";
	cin.get(message, MAXSTRLEN);
	SendData(message);
	cin.ignore();
	cout << "Enter count tablet -> ";
	cin.get(message, MAXSTRLEN);
	SendData(message);
	cin.ignore();
}
...
void ServerSocket::SendDataMessageServer(int summa)
{
	char message[MAXSTRLEN];
	char sumstr[MAXSTRLEN];
	sprintf_s(sumstr, "%d", summa);
	strcpy_s(message, "Total -> ");
	strcat_s(message, sumstr);
	cout << message;
	SendData(message);
}
